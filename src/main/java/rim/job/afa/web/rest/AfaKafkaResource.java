...
@RestController
@RequestMapping("/api/afa-kafka")
public class AfaKafkaResource {
    private final Logger log = LoggerFactory.getLogger(AfaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AfaKafkaResource(KafkaProperties kafkaProperties) {
